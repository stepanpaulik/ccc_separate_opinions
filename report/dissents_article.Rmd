...
title: "Why and when do (Czech) judges dissent: a quantitative empirical analysis of the Czech Constitutional Court"
author:
- name: Štěpán Paulík
...
Empirical legal research has been slowly but surely finding it's outside the predominant US context. Historically though most of the empirical studies have been conducted in the US, especially the Supreme Court, context [such as @boydUntanglingCausalEffects2010; @carrubbaWhoControlsContent2012; @epsteinWhyWhenJudges2011]. We now know that judgments are what judges had for a breakfast. Put less pompously, there are many theories and approaches for explanation of judicial decisions [@posnerHowJudgesThink2010]. What we do not know is the extent to which these theories and explanations carry over to other legal systems and context.
